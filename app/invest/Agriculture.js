...
export default function Agriculture() {
  return (
    <>
      <h1
        className="sm:text-[36px] sm:w-0 md:text-6xl flex  md:w-[331px] md:h-[43px] md:justify-normal  md:ml-[100px] font-bold font-[Clash Display] md:mb-20 mb-4 sm:mb-[60px] sm:mt-[100px] md:mt-[100px] text-[36px]  sm:mr-auto sm:pl-7"
        data-aos="fade-up"
      >
        Agriculture
      </h1>
      <div
        className="grid sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-3 md:w-[90%] sm:w-[90%] gap-10 md:ml-auto sm:ml-auto"
        data-aos="fade-up"
      >
        <div
          className="md:mr-28 sm:mr-5 lg:mr-20 md:mx-auto sm:mx-auto md:hidden lg:block sm:hidden md:w-[80%]"
          data-aos="fade-up"
        >
        ...
        <div
          className="md:col-span-2 md:mt-10 bg-white md:w-[100%] pb-10 sm:w-[95%] mr-auto"
          data-aos="fade-up"
        >
        ...
        <div
          className="sm:block md:mx-auto lg:hidden md:block"
          data-aos="fade-up"
        >
