...
export default function Entertainments() {
  ...
  return (
    <section className={styles.entertainments} data-aos="fade-up">
      <div className={styles.topWhite} data-aos="fade-up"></div>
      ...
      <div className={styles.entertainments_content} data-aos="fade-up">
        <div className={styles.entertainments_wrapper} data-aos="fade-up">
