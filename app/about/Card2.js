...
export default function Card2() {
  return (
    <>
      <div className="grid grid-cols-1 md:grid-cols-3 sm:w-[100%] sm:mx-auto gap-4 w-10/12 md:w-9/12 mx-auto mt-10">
        {/* hidden */}
        <div className="col-span-2 md:w-full p-2 md:p-5 mt-5 md:mt-0 bg-white rounded-[26px] hidden md:flex">
          <div className="">
            <div>
              <Image
                src={Img}
        ...
        <div className="p-2 w-[228.04px] md:w-[290px] xs:w-[90%] sm:w-[97%] sm:mx-auto">
          <button className="bg-secondary text-primary  py-2 items-center pl-[50px] pr-[11px] pt-[8px] pb-[8px] font-bold flex gap-10 rounded-[12px] md:w-[290px] md:h-[79px] sm:text-[14px] sm:pl-[26.5px] sm:pr-[6.31px] sm:pt-[8.68px] sm:pb-[6.31px] sm:w-[90%]">
            Ngwo Caves
        ...
        <div className="col-span-2 sm:mx-auto h-auto sm:w-[95%] p-2 md:w-full md:p-5 mt-5 md:mt-0 bg-white sm:rounded-[12.582px] rounded-[26px]">
          <div>
            <div>
              ...
              <Image
                src={Img}
                className="mx-auto w-[380.81px] md:w-[786.9px] md:h-[333.1px] h-[161.2px] p-2 object-cover rounded-[26px] sm:hidden md:block"
              />
            </div>
