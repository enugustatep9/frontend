...
import ChildrenCard from "../invest/ChildrenCard";

export default function RealEstateTest() {
  return (
    <>
      <h1 className="sm:text-[36px] sm:w-0 md:text-6xl flex  md:w-[331px] md:h-[43px] md:justify-normal  md:ml-[50px] font-bold font-[Clash Display] md:mb-20 mb-4 sm:mb-[60px] sm:mt-[150px] mt-[170px] text-[36px]  sm:mr-auto sm:pl-7">
        RealEstateeeee
      </h1>
      <div className="grid grid-cols-1 md:grid-cols-3 md:w-[90%] sm:w-[90%] gap-10 md:mr-auto sm:mr-auto">
        <div className="md:col-span-2 md:mt-10 bg-white md:w-[100%] pb-10">
          <div className="flex gap-4 md:ml-28 ml-10">
            <div>
              <Image
                src={Pic1}
                className="md:w-[100%] sm:w-[100%]  md:h-[530px] h-[300px] md:-mt-10 -mt-5"
              />
            </div>
        ...
        <div className="md:-mt-5 md:h-[369px] md:leading-[24.21px] ">
          <div className=" sm:mx-auto sm:w-[90%]  lg:ml-24">
            ...
            <div className="mt-5">
              <Link href="/explore">
                {" "}
                <Button text="Invest in TechVile" />
              </Link>
            </div>
          </div>
        </div>
